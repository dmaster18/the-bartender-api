...
const runQuestion = function(i, randomRecipes, quizScore) {
 ...
 const createLeaderboardForm = function(){
    ...
    leaderboardForm.innerHTML = '<form action="http://localhost:3000/users" method="POST"><input type="text" name="user[name]" value="name"> <button type="submit" value="Submit">Submit</button></form?'
